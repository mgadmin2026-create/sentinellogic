...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase
      ...
      .select(
        'id, file_id, file_name, file_type, kategorie, dokumenttyp, original_size, compressed_size, compression_ratio, created_at, kontakt_id, ordner_id, contacts(first_name, last_name)'
      )
    ...
    const rows = (data || []).map((d: any) => {
      ...
      return {
        ...
        dokumenttyp: d.dokumenttyp || null,
