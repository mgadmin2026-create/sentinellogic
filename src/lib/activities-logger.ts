...
export type ActivityType =
  ...
  | 'klicktipp_email_received'
  | 'klicktipp_email_opened'
  | 'klicktipp_email_clicked'
  | 'klicktipp_campaign_started'
  | 'klicktipp_campaign_finished'
  | 'klicktipp_tag_added'
  | 'klicktipp_tag_removed'
  | 'klicktipp_subscribed'
  | 'klicktipp_opt_in_pending'
  | 'klicktipp_unsubscribed'
  | 'klicktipp_soft_bounce'
  | 'klicktipp_hard_bounce'
  | 'klicktipp_status_changed'
  | 'dialfire_synced'
